...
* `ADR-003 was accepted by Carl on 2026-09-07, after the Story was implemented and the record was reviewable in PR #19. The Story recorded the decision and did not accept it; acceptance was a separate human act, which is the shape this Story argued for. The risk that remains is the ordinary one: an accepted decision can still be wrong, and its falsification condition is what would surface that`
