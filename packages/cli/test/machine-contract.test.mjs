...
test("AC-004: tooling capabilities report exact immutable versions", () => {
  ...
  assert.deepEqual(capabilities, {
    ...
    implementedProtocolVersion: "0.9.0",
...
test("AC-004: CLI serialization is canonical and newline terminated", () => {
  ...
  assert.equal(
    ...
    '{"schemaVersion":"1.0.0","protocolVersion":"0.9.0","status":"fail","outcome":"failure","exit":1,"subject":"story:TST-002","path":"specs/stories/TST-002/story.md","issues":[{"code":"MISSING_FIELD","message":"The Goal section is missing.","path":"specs/stories/TST-002/story.md","subject":"story:TST-002"}]}\n',
  );
});
